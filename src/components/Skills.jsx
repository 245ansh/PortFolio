...
const logoMap = {
  'C++': '/assets/logos/C++.svg',
  'Java': '/assets/logos/Java.svg',
  'JavaScript': '/assets/logos/JavaScript.svg',
  'HTML': '/assets/logos/HTML.svg',
  'CSS': '/assets/logos/CSS.svg',
  'SpringBoot': '/assets/logos/SpringBoot.svg',
  'SpringMVC': '/assets/logos/SpringMVC.svg',
  'Hibernate': '/assets/logos/Hibernate.svg',
  'ReactJS': '/assets/logos/ReactJS.svg',
  'TailwindCSS': '/assets/logos/TailwindCSS.svg',
  'Thymleaf': '/assets/logos/Thymeleaf.svg',
  'Git': '/assets/logos/Git.svg',
  'GitHub': '/assets/logos/Github.svg',
  'Postman': '/assets/logos/Postman.svg',
  'VS': '/assets/logos/VS.svg',
  'Intelli': '/assets/logos/Intelli.svg',
